    ...
    it('should return a list of Clients', (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body[0].Addresses.neightborhood).to.be.eql(defaultClient.Addresses.neightborhood);
    ...
    it('should return a client', (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body.Addresses.neightborhood).to.be.eql(defaultClient.Addresses.neightborhood);
